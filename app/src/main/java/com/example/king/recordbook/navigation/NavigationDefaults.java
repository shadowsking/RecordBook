...
import com.example.king.recordbook.navigation.NavigationIcons.NavigationIcon;
import com.example.king.recordbook.navigation.NavigationItems.NavigationItem;
...
public final class NavigationDefaults {
    ...
    public NavigationDefaults navigationIcon(int search, int nav_item_search, int type, @DrawableRes int drawableRes) {
        return navigationIcon(NavigationIcon.navigationIcon(type, drawableRes));
    }

    public NavigationDefaults navigationIcon(int type, @NonNull int drawable) {
